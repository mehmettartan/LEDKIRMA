...
namespace LEDKIRMA
{
    class FeasaCom
    {
        ...
        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_CaptureMultiRange")]
        public static extern int CaptureMultiRange(int CommPort, int isColorAutoRange, int isPWM, int CapturePWMFrames);
        ...
        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_DaisyChain_CheckDevice")]
        public static extern int DaisyChain_CheckDevice(int CommPort, string SerialNumber);

        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_DaisyChain_CheckAllDevices")]
        public static extern int DaisyChain_CheckAllDevices(int CommPort);
        ...
        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_DaisyChain_CaptureMultiRange")]
        public static extern int DaisyChain_CaptureMultiRange(int CommPort, int isColorAutoRange, int isPWM, int CapturePWMFrames);
        ...
        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_ExternalTrigger_Enable")]
        public static extern int ExternalTrigger_Enable(int CommPort, int CaptureRange, int isPWM, string OutputType, int PreDelay, int PostDelay, int toFlash);

        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_ExternalTrigger_Spectrometer_Enable")]
        public static extern int ExternalTrigger_Spectrometer_Enable(int CommPort, float IntegrationTime, int PreDelay, int PostDelay, int toFlash);

        [DllImport(DLL_FEASACOM, EntryPoint = "FeasaCom_ExternalTrigger_Disable")]
        public static extern int ExternalTrigger_Disable(int CommPort, int toFlash);
